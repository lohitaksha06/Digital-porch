      ...
      <div className="main-content">
        ...
        <div className="content-area">
          ...
          <div className="blog-feed">
            ...
            <div className="blog-post-card" onClick={() => router.push('/demo?id=1')}>
            ...
            <div className="blog-post-card" onClick={() => router.push('/demo?id=2')}>
            ...
            <div className="blog-post-card" onClick={() => router.push('/demo?id=3')}>
